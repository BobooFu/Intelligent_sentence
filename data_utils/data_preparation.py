...
train_data_process.decompose_data('articles','./train.csv')  # decompose data - 取出原始数据中的选定标签的数据
...
train_data_process.decompose_data('accusation','./train.csv')  # decompose data 
